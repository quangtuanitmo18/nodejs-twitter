...
class UsersService {
  ...
  async verifyEmail(user_id: string) {
    ...
    // xoa di nhung refresh token cu
    // luc register tao token xong verify lai tao token dan den 1 cai bi thua  (can xoa cai luc chua verify)
